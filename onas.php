...
<div id="wrapper">
	...
	<div>
    <h3 style="text-align:center;font-size:26px;margin:0;padding-top:26px;background:#F8F8F8" >Ogólnopolska wypożyczalnia samochodów Szybkie auta - Łukasz Dziadosz</h3>
	<section class="onas-left" style="float:left;width:47%;">
	...
	<section class="onas-right" style="float:right;width:47%">
